...
class TestAzureCredentialLocking:
    ...
    @patch(
        "learn_to_cloud_shared.core.azure_auth.ManagedIdentityCredential",
        autospec=True,
    )
    async def test_single_credential_created_on_concurrent_calls(
        ...
        from learn_to_cloud_shared.core.azure_auth import get_credential
...
class TestAzureGetToken:
    ...
    async def test_successful_token_acquisition(self):
        ...
        with patch(
            ...
            from learn_to_cloud_shared.core.azure_auth import get_token
...
class TestCloseCredential:
    ...
    async def test_close_credential_closes_transport(self):
        ...
        import learn_to_cloud_shared.core.azure_auth as auth_mod
...
class TestCheckoutEventTransactionCleanup:
    ...
    def test_rollback_and_reset_when_in_transaction(self):
        ...
        from learn_to_cloud_shared.core.database import _setup_pool_event_listeners
        ...
        with patch(
            "learn_to_cloud_shared.core.database.event.listens_for",
            autospec=True,
...
class TestCheckDbConnection:
    ...
    async def test_timeout_on_hanging_connection(self):
        ...
        with (
            patch(
                "learn_to_cloud_shared.core.database.asyncio.timeout",
                autospec=True,
